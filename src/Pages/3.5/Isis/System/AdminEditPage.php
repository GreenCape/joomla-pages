...
use Facebook\WebDriver\WebDriverElement as WebElement;
...
abstract class AdminEditPage extends AdminPage
{
	...
	public function getFieldValue($label)
	{
		...
		{
			throw new \Facebook\WebDriver\Exception\NoSuchElementException("Element '$label' not found");
		}
	...
	public function getToolTip($tabText, $id)
	{
		...
		$this->driver->executeScript("document.getElementById(arguments[0]).fireEvent('mouseenter');", [$id]);
		sleep(1);
